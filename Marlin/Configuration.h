...
#define STRING_CONFIG_H_AUTHOR "Sarbjit Singh" // Who made the changes.
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.25, 80.25, 1600, 139.25 }
 ...
 *                                      X, Y, Z [, I [, J [, K]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 150, 150, 4, 150 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 24, 5, -0.80 }
...
#define PREHEAT_2_LABEL       "PLA-Thin"
